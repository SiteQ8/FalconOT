...
## ICS/OT-Specific Standards

Given the critical nature of Industrial Control Systems and Operational Technology:

- **Never** share or encourage the use of exploits against live ICS/OT systems without proper authorization
- **Always** advocate for responsible disclosure of vulnerabilities
- **Respect** that OT environments can have safety-of-life implications
- **Promote** safe scanning practices and authorized testing only
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainer at **site@hotmail.com**.
